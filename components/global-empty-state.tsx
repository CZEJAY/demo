...
export function EmptyState({ title, description, actionLabel, actionLink, className, ...props }: EmptyStateProps) {
  return (
    <div className={cn('flex flex-col items-center justify-center min-h-[400px] text-center', className)} {...props}>
      <div className="relative w-[300px] h-[200px] mb-8">
        <svg className="w-full h-full" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M185 130C185 130 195 120 215 130" stroke="white" strokeWidth="2" strokeLinecap="round" />
      ...
      {description && (
        <p className="text-muted-foreground mb-4 max-w-[500px]">
          ...
          {actionLabel && actionLink && (
            <Button variant="link" className="text-primary underline -ml-2" asChild>
