      ...
      {contentTypes.map(type => {
        ...
        return (
          <Button
            ...
            variant="outline"
            className={cn(
              'flex-1 gap-2 bg-white/50 hover:bg-white/80 items-center justify-center flex flex-col py-9 md:py-10',
              value === type.value && 'bg-purple-50 text-primary hover:bg-primary/80',
            )}
